...
**Update January 2020, [updated version]({{< relref "/post/becoming-a-hyperledger-aries-developer-part-3-connecting-using-didcomm-exchange" >}}):** _I have received questions about creating a connection between two agents, which made me read this blog post again. A lot had changed, and I have learned a lot since I wrote it, so I've created [a new blog post]({{< relref "/post/becoming-a-hyperledger-aries-developer-part-3-connecting-using-didcomm-exchange" >}}) which uses DID Exchange. I'm leaving this blog post unchanged, so you and I can use it as a reference later. Feel free to contact me in case you have any questions!_
